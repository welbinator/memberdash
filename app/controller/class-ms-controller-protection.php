<?php
/**
 * Controller for managing Protection Rules.
 *
 * @since 1.0.0
 * @package MemberDash
...
class MS_Controller_Protection extends MS_Controller {
	...
	public function enqueue_scripts() {
		...
		switch ( $this->get_active_tab() ) {
			case 'url':
				$data['valid_rule_msg']   = __( 'Valid', 'memberdash' );
				$data['invalid_rule_msg'] = __( 'Invalid', 'memberdash' );
				$data['empty_msg']        = __( 'Before testing you have to first enter one or more Page URLs above.', 'memberdash' );
