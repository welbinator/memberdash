...
class MS_Controller_Help extends MS_Controller {
	...
	public function get_tabs() {
		$tabs = array(
			...
			'shortcodes' => array(
				'title' => __( 'Shortcodes', 'memberdash' ),
			),
			'network'    => array(
				'title' => __( 'Network-Wide Protection', 'memberdash' ),
			),
			'advanced'   => array(
				'title' => __( 'Advanced Settings', 'memberdash' ),
			),
			'branding'   => array(
				'title' => __( 'Customize Membership', 'memberdash' ),
			),
			'emails'     => array(
				'title' => __( 'Email history', 'memberdash' ),
			),

			/*
			'api'         => array(
				'title' 	=> __( 'API Docs', 'memberdash' ),
