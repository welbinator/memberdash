...
class MS_View_Billing_Edit extends MS_View {
	...
	public function to_html() {
		...
		if ( $this->data['invoice']->is_valid() ) {
			$title = __( 'Edit Billing', 'memberdash' );
		} else {
			$title = __( 'Add Billing', 'memberdash' );
		}
	...
	public function prepare_fields() {
		...
		if ( $invoice->id ) {
			...
			$transaction_link = sprintf(
				...
				__( 'Show Transactions', 'memberdash' )
			);
		} else {
		...
		$fields = array(
			...
			'txt_user'          => array(
				'id'    => 'txt_user',
				'title' => __( 'Invoice for member', 'memberdash' ),
				'type'  => MS_Helper_Html::TYPE_HTML_TEXT,
				'value' => sprintf(
					'<a href="%s">%s</a>',
					MS_Controller_Plugin::get_admin_url(
			...
			'txt_membership'    => array(
				'id'    => 'txt_membership',
				'title' => __( 'Payment for membership', 'memberdash' ),
				'type'  => MS_Helper_Html::TYPE_HTML_TEXT,
			),
			'txt_created'       => array(
				'id'    => 'txt_created',
				'title' => __( 'Invoice created on', 'memberdash' ),
				'type'  => MS_Helper_Html::TYPE_HTML_TEXT,
			),
			'txt_separator'     => array(
			...
			'status'            => array(
				'id'            => 'status',
				'title'         => __( 'Invoice status', 'memberdash' ),
			...
			'amount'            => array(
				'id'     => 'amount',
				'title'  => sprintf( __( 'Amount (%s)', 'memberdash' ), $currency ),
			...
			'discount'          => array(
				'id'     => 'discount',
				'title'  => sprintf( __( 'Discount (%s)', 'memberdash' ), $currency ),
				'type'   => MS_Helper_Html::INPUT_TYPE_NUMBER,
			...
			'due_date'          => array(
				'id'    => 'due_date',
				'title' => __( 'Due date', 'memberdash' ),
				'type'  => MS_Helper_Html::INPUT_TYPE_DATEPICKER,
				'value' => $invoice->due_date,
			),
			'description'       => array(
				'id'    => 'description',
				'title' => __( 'Description', 'memberdash' ),
			...
			'execute'           => array(
				'id'    => 'execute',
				'title' => __( 'Execute status change actions on Save (add/remove membership)', 'memberdash' ),
				'type'  => MS_Helper_Html::INPUT_TYPE_CHECKBOX,
				'value' => true,
			),
			'modify_date'       => array(
				'title' => __( 'Extend the expire date of the active membership once paid', 'memberdash' ),
				'name'  => 'modify_date',
				'type'  => MS_Helper_Html::INPUT_TYPE_CHECKBOX,
				'value' => true,
			),
