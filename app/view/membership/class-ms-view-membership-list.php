...
class MS_View_Membership_List extends MS_View {
	...
	public function to_html() {
		...
		$create_new_button = array(
			...
			'value' => __( 'Create New Membership', 'memberdash' ),
			'class' => 'button',
		);
		...
		$delete_button = array(
			...
			'value' => __( 'Delete Selected Memberships', 'memberdash' ),
		...
		<div class="wrap ms-wrap">
			...
			MS_Helper_Html::settings_header(
				array(
					'title' => $title,
					'desc'  => array(
						__( 'Here you can view and edit all the Memberships you have created.', 'memberdash' ),
						$admin_message,
					),
				)
			);
			...
			<form action="" method="post">
				<div class="ms-list-table-wrapper ms-membership-list">
					<div class="ms-flex ms-space-x-2">
						<?php
