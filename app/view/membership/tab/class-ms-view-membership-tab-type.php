		...
		<div class="ms-membership-add ms-cols-2">
			<form method="post" id="ms-choose-type-form">
				<div class="ms-settings-row cf">
					<h3><?php esc_html_e( 'Set the membership type:', 'memberdash' ); ?></h3>
	...
	public function prepare_fields() {
		...
		$fields = array(
			'type'           => array(
				...
				'class'         => 'ms-choose-type ms--ml-1',
				'after'         => '<div class="ms-italic ms-block ms--ml-2 ms-mt-4">' . __( 'Changing this option might result in loss or changes in your protection rules for this Membership.<br>Please check your rules after you save changes here.', 'memberdash' ) . '</div>',
				'field_options' => array(
