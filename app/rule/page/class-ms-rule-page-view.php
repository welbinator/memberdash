...
class MS_Rule_Page_View extends MS_View {
	...
	public function to_html() {
		...
		$header_data = apply_filters(
			...
			array(
				'title' => __( 'Apply protection to Pages and grant access to members', 'memberdash' ),
				'desc'  => __( 'All pages that do not have Content Protection applied are visible to Everyone', 'memberdash' ),
			),
