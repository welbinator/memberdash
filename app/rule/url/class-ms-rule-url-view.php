	...
	public function to_html() {
		...
		if ( $listtable->list_shows_base_items() ) {
			$add_fields = array(
				'url'        => array(
					'id'    => 'url_value',
					'title' => __( 'Add new URL Address', 'memberdash' ),
				...
				'url_add'    => array(
					...
					'value'       => __( 'Protect this URL', 'memberdash' ),
					'button_type' => 'button',
				),
				'url_action' => array(
					'name'  => 'rule_action',
		...
		$header_data = apply_filters(
			...
			array(
				'title' => __( 'URL Restriction', 'memberdash' ),
				'desc'  => array(
					__( 'Specify URLs that you want to protect.', 'memberdash' ),
					__( 'e.g. <b>example.com/protectme/</b> will protect all URLs that contain <b>example.com/protectme/</b>, including any child page.', 'memberdash' ),
				),
				'class' => '',
			),
			MS_Rule_Url::RULE_ID,
