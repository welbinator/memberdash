...
class MS_Rule_MemberCaps_Model extends MS_Rule {
	 ...
	 * @var array
	 */
	protected static $real_caps = array();
	...
	/**
	 * Get a simple array of capabilities (e.g. for display in select lists)
	 *
	 * @since 1.0.0
	 *
	 * @global array $menu
	...
	public function get_capabilities( $args = null ) {
		if ( null === $this->_content_array ) {
			...
			// If not visitor membership, just show Membership
