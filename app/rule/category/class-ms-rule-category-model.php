...
class MS_Rule_Category_Model extends MS_Rule {
	 ...
	 * @var array
	 */
	public static $protected_categories = array();
	...
	/**
	 * Verify access to the current category or post belonging to a category.
	 *
	 * @since 1.0.0
	 *
	 * @param int  $id               The current post_id.
	 * @param bool $admin_has_access If admin has access or not.
	 * @param bool $check_category   If check category or not.
	 *
	 * @return bool|null True if has access, false otherwise.
	 *     Null means: Rule not relevant for current page.
	 */
