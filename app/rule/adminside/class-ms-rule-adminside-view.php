...
class MS_Rule_Adminside_View extends MS_View {
	...
	public function to_html() {
		...
		$header_data = apply_filters(
			...
			array(
				'title' => __( 'Protect Admin Side pages', 'memberdash' ),
				'desc'  => array(
					__( 'Note that WordPress also restricts access to pages before Content Protection is applied.', 'memberdash' ),
					__( 'Tip: Combine with the <b>User Role</b> rules to grant your members additional permission if required!', 'memberdash' ),
				),
			),
