...
export default function Edit( props ) {
    ...
    if ( props.attributes.id == undefined || props.attributes.id == '' ) {
        return (
            <div className="ms-membership-price">
                <InspectorControls>
                    <PanelBody title="Block Settings">
                        ...
                        <PanelRow>
                            <ToggleControl label="Show currency" checked={ props.attributes.currency } onChange={ currency } />
                        </PanelRow>
                        <PanelRow>
    ...
    return (
        <div className="ms-membership-price">
            ...
            <ServerSideRender
                block="memberdash/ms-membership-price"
                attributes={ {
                    id: props.attributes.id,
                    currency: props.attributes.currency,
