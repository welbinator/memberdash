...
class MS_Model_Rule extends MS_Model {
	 ...
	 * @var array
	 */
	protected static $rule_meta = null;
	 ...
	 * This hierarchy is used to determine access to Membership.
	 *
	 * @since 1.0.0
	...
	public static function get_dripped_types() {
		$dripped_types = array(
			self::DRIPPED_TYPE_INSTANTLY         => __( 'Instantly', 'memberdash' ),
			self::DRIPPED_TYPE_SPEC_DATE         => __( 'On specific Date', 'memberdash' ),
			self::DRIPPED_TYPE_FROM_REGISTRATION => __( 'Relative to Subscription', 'memberdash' ),
		);
