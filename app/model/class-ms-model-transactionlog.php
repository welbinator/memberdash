...
class MS_Model_Transactionlog extends MS_Model_CustomPostType {
	...
	/**
	 * Indicator if the transaction was successfully processed by MWPS
	 *
	...
	public static function get_register_post_type_args() {
		$args = array(
			'label'               => __( 'Membership Transaction Logs', 'memberdash' ),
			'supports'            => array(),
			'hierarchical'        => false,
			'public'              => false,
			'show_ui'             => false,
		...
		switch ( $state ) {
			...
			case 'clear':
				if ( 'ignore' != $this->manual_state ) {
					// Not allowed: Only "ignored" state can be cleared.
					return false;
				}
				break;
