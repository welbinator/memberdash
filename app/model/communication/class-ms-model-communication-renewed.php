...
class MS_Model_Communication_Renewed extends MS_Model_Communication {
	...
	public function get_description() {
		return __(
			'Sent to the member when a previously expired or cancelled membership is renewed - triggered for both free and paid memberships.',
			'memberdash'
		);
	}
	...
	public function reset_to_default() {
		...
		$this->subject = sprintf(
			__( 'Subscription renewed for %s', 'memberdash' ),
	...
	public static function get_default_message() {
		...
		$body_notice  = sprintf(
			__( 'Thanks for renewing your <strong>%1$s</strong> subscription over at %2$s!', 'memberdash' ),
