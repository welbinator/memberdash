...
class MS_Model_Communication_Before_Finishes extends MS_Model_Communication {
	...
	public function get_description() {
		return __(
			'Sent a predefined number of days before the membership finishes. You must decide how many days beforehand a message is to be sent.',
			'memberdash'
		);
	}
	...
	public function reset_to_default() {
		...
		$this->subject        = sprintf(
			__( 'Your %s membership will end soon', 'memberdash' ),
	...
	public static function get_default_message() {
		...
		$body_notice = sprintf(
			__( 'This is just a reminder that your %1$s membership at %2$s will end in %3$s.', 'memberdash' ),
			self::COMM_VAR_MS_NAME,
