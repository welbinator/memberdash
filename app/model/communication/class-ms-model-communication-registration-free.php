...
class MS_Model_Communication_Registration_Free extends MS_Model_Communication_Registration {
	...
	public function get_description() {
		return __(
			'Sent when a member completes the signup for a free membership.',
			'memberdash'
		);
	}
	...
	public static function get_default_message() {
		...
		$body_notice  = sprintf(
			__( 'Thanks for subscribing to our free <strong>%1$s</strong> membership at %2$s!', 'memberdash' ),
	...
	public function process_communication( $event, $subscription ) {
		...
		// Email for paid memberships is in MS_Model_Communication_Registration.
