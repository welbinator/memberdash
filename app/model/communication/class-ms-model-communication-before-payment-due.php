...
class MS_Model_Communication_Before_Payment_Due extends MS_Model_Communication {
	...
	public function set_period_name( $field ) {
		$field['title'] = __( 'Notice Period', 'memberdash' );
		$field['desc']  = __( 'Define, how many days in advance the user should be notified.', 'memberdash' );
	...
	public function get_description() {
		return __(
			'Sent a predefined number of days before the payment is due. You must decide how many days beforehand a message is to be sent.',
			'memberdash'
		);
	}
	...
	public function reset_to_default() {
		...
		$this->subject        = __( 'Membership payment due soon', 'memberdash' );
	...
	public static function get_default_message() {
		...
		$body_notice  = sprintf(
			__( 'This is a reminder that the next payment for your %1$s membership at %2$s will be due on (%3$s).', 'memberdash' ),
