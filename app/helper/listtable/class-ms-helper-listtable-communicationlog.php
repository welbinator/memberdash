...
class MS_Helper_ListTable_CommunicationLog extends MS_Helper_ListTable {
	...
	public function get_columns() {
		$columns = apply_filters(
			...
			array(
				'id'      => __( 'ID', 'memberdash' ),
				'date'    => __( 'Time', 'memberdash' ),
				'status'  => '',
				'type'    => __( 'Type', 'memberdash' ),
				'details' => __( 'Details', 'memberdash' ),
			)
		);
	...
	public function column_status( $item, $column_name ) {
		if ( $item->sent ) {
			$html = '<i class="memberdash-fa memberdash-fa-check"></i>';
		} else {
			$html = '<i class="memberdash-fa memberdash-fa-circle"></i>';
		}
	...
	public function column_details( $item, $column_name ) {
		...
		$html = sprintf(
			...
			'<i class="memberdash-fa memberdash-fa-info-circle"></i>',
