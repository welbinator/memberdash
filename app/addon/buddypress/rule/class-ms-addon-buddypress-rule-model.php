...
class MS_Addon_BuddyPress_Rule_Model extends MS_Rule {
	...
	public function get_contents( $args = null ) {
		...
		$contents[ MS_Addon_BuddyPress_Rule::PROTECT_ALL ] = (object) array(
			...
			'name'        => __( 'All BuddyPress Pages', 'memberdash' ),
			'type'        => $this->rule_type,
			'description' => __( 'Protect all BuddyPress pages. This rule can be combined with any of the other rules.', 'memberdash' ),
		...
		$contents[ MS_Addon_BuddyPress_Rule::PROTECT_GROUP_CREATION ] = (object) array(
			...
			'name'        => __( 'Group creation', 'memberdash' ),
			'type'        => $this->rule_type,
			'description' => __( 'Only members can create new groups.', 'memberdash' ),
		...
		$contents[ MS_Addon_BuddyPress_Rule::PROTECT_FRIENDSHIP ] = (object) array(
			...
			'name'        => __( 'Friendship request', 'memberdash' ),
			'type'        => $this->rule_type,
			'description' => __( 'Only allow members to send friendship requests.', 'memberdash' ),
		...
		$contents[ MS_Addon_BuddyPress_Rule::PROTECT_PRIVATE_MSG ] = (object) array(
			...
			'name'        => __( 'Private messaging', 'memberdash' ),
			'type'        => $this->rule_type,
			'description' => __( 'Only allow members to send private messages.', 'memberdash' ),
		...
		$contents[ MS_Addon_BuddyPress_Rule::PROTECT_MEMBERS ] = (object) array(
			...
			'name'        => __( 'Member listing', 'memberdash' ),
			'type'        => $this->rule_type,
			'description' => __( 'Only members can see the BuddyPress Member Directory and Member Profiles.', 'memberdash' ),
