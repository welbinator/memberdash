...
class MS_Addon_Coupon_Helper_Listtable extends MS_Helper_ListTable {
	...
	public function get_columns() {
		return apply_filters(
			'ms_addon_coupon_helper_list_table_columns',
			array(
				'cb'             => '<input type="checkbox" />',
				'ccode'          => __( 'Coupon Code', 'memberdash' ),
				'discount'       => __( 'Discount', 'memberdash' ),
				'start_date'     => __( 'Start date', 'memberdash' ),
				'expire_date'    => __( 'Expire date', 'memberdash' ),
				'membership'     => __( 'Membership', 'memberdash' ),
				'used'           => __( 'Used', 'memberdash' ),
				'remaining_uses' => __( 'Remaining uses', 'memberdash' ),
			)
		);
	}
	...
	public function prepare_items() {
		...
		$this->items = apply_filters(
			'ms_addon_coupon_helper_list_table_items',
